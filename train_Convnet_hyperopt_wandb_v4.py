...
entity = 'mellache'
project = 'nested_cv_hcp_dev_age_model_bias_correction_2_27_24'
...
def train_with_wandb(config=None):
    ...
    with wandb.init(config=config):
        ...
        for inner_train_idx, inner_val_idx in inner_cv.split(X_train,y_train):
            ...
            # Train the model
            fname_model = 'best_inner_fold_hcp_dev_age_model_2_27_24.pt'
            ...
            if val_loss_temp < best_inner_score:
                ...
                best_model_filename = f'best_model_inner_fold_2_27_24.pt'
                torch.save(model.state_dict(),best_model_filename)
                artifact = wandb.Artifact(f'best_model_inner_fold_2_27_24',type='model')
...
for fold in range(5):
    ...
    fname_model_outer = f'best_outer_fold_{fold}_hcp_dev_model_2_27_24.pt'
