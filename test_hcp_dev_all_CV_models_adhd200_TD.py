...
path = '/oak/stanford/groups/menon/projects/mellache/2021_foundation_model/data/imaging/for_dnn/adhd200_regression_age_TD_wIDs/fold_0.bin'
...
np.savez('lin_params_td_adhd200',coef=coef_list,intercept=intercept_list)

np.savez('actual_adhd200_td_ages_oct25',actual=actual_ages)
np.savez('predicted_adhd200_td_ages_oct25',predicted=predicted_ages)
...
ax.set_yticks(np.arange(6, 25, 2))
...
ax.set_title("ADHD-200 TD Brain Age Prediction",fontsize=16,pad=10)
plt.tight_layout(pad=1.2)
#plt.savefig('adhd200_td_brain_age_scatter_ensemble_prediction_test_bias_correction_high_quality.png',format='png')
pdf.FigureCanvas(fig).print_pdf('adhd200_td_brain_age_scatter_ensemble_prediction_test_bias_correction_high_quality.ai')
