...
np.savez('lin_params_td_cmihbn',coef=coef_list,intercept=intercept_list)
np.savez('actual_cmihbn_td_ages_oct25',actual=actual_ages)
np.savez('predicted_cmihbn_td_ages_oct25',predicted=predicted_ages)
#pdb.set_trace()
...
ax.set_title("CMI-HBN",fontsize=16,pad=10)
plt.tight_layout(pad=1.2)
#plt.savefig('cmihbn_td_brain_age_scatter_ensemble_prediction_test_bias_correction_high_quality.png',format='png')
pdf.FigureCanvas(fig).print_pdf('cmihbn_td_brain_age_scatter_ensemble_prediction_test_bias_correction_high_quality.ai')
pdb.set_trace()
