...
lin_params = np.load('/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/scripts/generalization/adhd200_updated/lin_params_td_adhd200.npz')
...
np.savez('actual_adhd200_ages_most_updated',actual=actual_ages)
np.savez('predicted_adhd200_ages_most_updated',predicted=predicted_ages)
...
ax.set_title("ADHD-200 ADHD Age Prediction",fontsize=16,pad=10)
plt.tight_layout(pad=1.2)
#plt.savefig('adhd200_adhd_brain_age_scatter_ensemble_prediction_test_bias_correction_high_quality.png',format='png')
pdf.FigureCanvas(fig).print_pdf('adhd200_adhd_brain_age_scatter_ensemble_prediction_all_td_bias_correction_high_quality.ai')
