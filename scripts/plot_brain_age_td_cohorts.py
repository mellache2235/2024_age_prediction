#!/usr/bin/env python3
"""
Create combined brain age prediction scatter plots for TD cohorts.

This script creates a single scatter plot panel combining all TD cohorts
(ABIDE TD, CMI-HBN TD, ADHD200 TD, NKI) with different colors for each dataset.
"""
...
def plot_combined_td_cohorts(npz_files_dir: str, output_path: str, 
    ...
    # Plot each dataset
    for dataset_name, dataset_info in td_datasets.items():
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Create combined brain age prediction scatter plot for TD cohorts",
