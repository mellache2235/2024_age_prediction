...
if __name__ == '__main__':
    ...
    path = '/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/data/cmihbn_age_ADHD_weidong_cutoffs/fold_0.bin'
    ...
    HY_total = np.concatenate((Y_train,Y_valid))
    ...
    #features_df = get_and_analyze_features(X_total,Y_total, sc)
    #features_df.to_csv('cmihbn_adhd_weidong_cutoffs_features_all_sites_IG_convnet_regressor_trained_on_hcp_dev_top_regions_wIDS_single_model_predictions.csv')
