...
# SUB_DIR = ""
SUB_DIR = "06_26_2024"
ig_dir = '/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/results/figures/stanford/ig_files/'
num_models = 500
# num_models = 5 * 2
# num_models = 2
#percentiles = [90]
...
for percentile in percentiles:
    ...
    for group in groups.keys():
        ...
        for k in range(num_models):
            print(f"Model_idx={k}")
            ig_k = np.load(
                os.path.join(ig_dir, f"dev_age_model_{k}_ig_stanford_asd.npz"),
                allow_pickle=True,
            )
        ...
        excel_file = os.path.join(ig_dir, f"top_{thresh}_consensus_features_stanford_asd_aging.xlsx")
