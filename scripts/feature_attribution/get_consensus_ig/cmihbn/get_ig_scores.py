...
def get_and_analyze_features(data_all, labels_all, fname_model, fold_number):
    ig_path = '/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/results/figures/cmihbn/ig_files/'
    ...
    for idx, i in enumerate(range(0, len(ig_tensor_data), 10)):
        ...
        del attr, delta
    fname = f"dev_age_model_{fold_number}_ig_cmihbn_adhd" 
