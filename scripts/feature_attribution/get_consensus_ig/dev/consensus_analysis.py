...
# SUB_DIR = ""
SUB_DIR = "06_26_2024"
ig_dir = '/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/results/figures/dev/ig_files/'
num_models = 500
# num_models = 5 * 2
# num_models = 2
#percentiles = [90]
...
for percentile in percentiles:
    ...
    for group in groups.keys():
        ...
        excel_file = os.path.join(ig_dir, f"top_{thresh}_consensus_features_hcp_dev_aging.xlsx")
