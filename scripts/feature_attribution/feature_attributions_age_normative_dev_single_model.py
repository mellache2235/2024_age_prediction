...
if __name__ == '__main__':
    ...
    X_total = np.concatenate((X_train_dev,X_train_dev))
    Y_total = np.concatenate((Y_train_dev,Y_valid_dev))
    ...
    features_df = get_and_analyze_features(X_total,Y_total)
    features_df.to_csv('hcp_dev_features_IG_convnet_regressor_single_model_fold_0.csv')
