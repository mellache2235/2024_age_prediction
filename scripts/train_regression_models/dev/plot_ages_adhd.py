...
predicted = np.load('/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/scripts/generalization/cmihbn_updated/predicted_cmihbn_adhd_ages_most_updated.npz')
actual = np.load('/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/scripts/generalization/cmihbn_updated/actual_cmihbn_adhd_ages_most_updated.npz')
...
ax1.set_title("CMI-HBN",fontsize=15,pad=10)
...
predicted_adhd200 = np.load('/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/scripts/generalization/adhd200_updated/predicted_adhd200_ages_most_updated.npz')
actual_adhd200 = np.load('/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/scripts/generalization/adhd200_updated/actual_adhd200_ages_most_updated.npz')
...
ax2.set_title("ADHD-200",fontsize=15,pad=10)

plt.savefig('adhd_brain_age_prediction_figure.png',format='png')
pdf.FigureCanvas(fig).print_pdf('adhd_brain_age_prediction_figure.ai')
