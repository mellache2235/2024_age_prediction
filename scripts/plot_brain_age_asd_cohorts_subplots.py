...
Examples:
  ...
  python plot_brain_age_asd_cohorts_subplots.py --npz_dir . --output_dir results/brain_age_plots
  
  # Create plot with custom title
  python plot_brain_age_asd_cohorts_subplots.py --npz_dir . --output_dir results/brain_age_plots --title "ASD Cohorts Brain Age Prediction"
        """
    )
