...
Examples:
  ...
  python plot_brain_behavior_analysis.py \\
    --results_file /oak/stanford/groups/menon/projects/mellache/2024_age_prediction_test/results/brain_behavior_results.json \\
    --output_dir /oak/stanford/groups/menon/projects/mellache/2024_age_prediction_test/results/figures/brain_behavior_analysis
  ...
  python plot_brain_behavior_analysis.py \\
    ...
    parser.add_argument("--output_dir", type=str, default="/oak/stanford/groups/menon/projects/mellache/2024_age_prediction_test/results/figures/brain_behavior_analysis",
