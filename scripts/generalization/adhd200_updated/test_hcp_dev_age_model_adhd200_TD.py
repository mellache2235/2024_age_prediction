...
ax.set_title("ADHD200 TD",fontsize=16)
plt.savefig('adhd200_td_brain_age_scatter_test_bias_correction.png',format='png')


pdb.set_trace()
'''

np.savez('adhd200_td_predicted_ages',predicted=predicted_ages)
np.savez('adhd200_td_actual_ages',actual=actual_ages)
pdb.set_trace()
