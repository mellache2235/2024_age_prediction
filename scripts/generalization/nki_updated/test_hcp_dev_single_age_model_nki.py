...
np.savez("lin_model_params_nki_single_model.npz", coef=coef_list, intercept=intercept_list)
pdb.set_trace()
...
plt.savefig('nki_brain_age_scatter_test_bias_correction_single_model.png',format='png')
