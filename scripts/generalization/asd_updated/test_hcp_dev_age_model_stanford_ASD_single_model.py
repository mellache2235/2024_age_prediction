...
Y_total = np.squeeze(sc.transform(Y_total.reshape(-1,1)))
 
X_total_resampled = signal.resample(X_total,math.floor(X_total.shape[1] * 0.49 / 0.8),axis=1)

X_total = reshapeData(X_total_resampled)
...
plt.savefig('stanford_asd_brain_age_scatter_test_bias_correction_single_model.png',format='png')
