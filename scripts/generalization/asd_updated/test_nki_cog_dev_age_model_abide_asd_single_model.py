...
appended_data_asd_dev['gender'] = appended_data_asd_dev['gender'].astype('str')
appended_data_asd_dev['subject_id'] = appended_data_asd_dev['subject_id'].astype('str')

genders_asd = np.asarray(appended_data_asd_dev['gender'])
...
plt.savefig('abide_asd_brain_age_scatter_test_bias_correction_single_model.png',format='png')
