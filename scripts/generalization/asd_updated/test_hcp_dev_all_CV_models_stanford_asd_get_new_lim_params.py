...
path = '/oak/stanford/groups/menon/projects/mellache/2021_foundation_model/data/imaging/for_dnn/stanford_autism_age_TD_wIDS/fold_0.bin'
...
#np.savez('lin_params_td_stanford',coef=coef_list,intercept=intercept_list)
#pdb.set_trace()
...
np.savez('actual_stanford_td_ages_most_updated',actual=actual_ages)
np.savez('predicted_stanford_td_ages_most_updated',predicted=predicted_ages)
pdb.set_trace()
