...
Examples:
  ...
  python plot_brain_age_correlations.py \\
    --results_file /oak/stanford/groups/menon/projects/mellache/2024_age_prediction_test/results/brain_age_prediction_results.json \\
    --output_dir /oak/stanford/groups/menon/projects/mellache/2024_age_prediction_test/results/figures/brain_age_correlations
  ...
  python plot_brain_age_correlations.py \\
    ...
    parser.add_argument("--output_dir", type=str, default="/oak/stanford/groups/menon/projects/mellache/2024_age_prediction_test/results/figures/brain_age_correlations",
