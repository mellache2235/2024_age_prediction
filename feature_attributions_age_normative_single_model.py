...
if __name__ == '__main__':
    ...
    data_dir = '/oak/stanford/groups/menon/projects/mellache/2021_foundation_model/data/imaging/for_dnn/adhd200_regression_age_ADHD_wIDs/'
    ...
    hy_data = np.load(hy_dir + 'adhd200_run-rest_brainnetome_mean_regMov-6param_wmcsf_dt1_bpf008-09_normz_246ROIs.pklz',allow_pickle=True)
    ...
    ax.set_ylabel("Hyperactivity",fontsize=16,labelpad=10)
    ...
    pdf.FigureCanvas(fig).print_pdf('adhd200_BAG_HY_NYU_only_pretty.ai')
    '''
    ...
    plt.tight_layout(pad=1.2)
    pdf.FigureCanvas(fig).print_pdf('adhd200_BAG_HY_Peking_only_pretty.ai')
    '''
    ...
    ax.spines[['right', 'top']].set_visible(False)
    ax.set_xlabel("Observed Hyperactivity",fontsize=15,labelpad=10)
    ax.set_ylabel("Predicted Hyperactivity",fontsize=15,labelpad=10)
    ax.set_title("Brain-Behavior Analysis: ADHD-200 NYU",fontsize=14,pad=10)
    plt.tight_layout(pad=1.2)
    #plt.savefig('adhd200_pca_regression_features_HY_Peking_only_scatter_pretty.png',format='png')
    pdf.FigureCanvas(fig).print_pdf('adhd200_pca_regression_features_HY_NYU_only_scatter_pretty_v2.ai')
    #print(len(ids_all))
    #print(len(hys_all))
