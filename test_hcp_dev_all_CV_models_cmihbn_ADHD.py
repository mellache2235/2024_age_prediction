...
path = '/oak/stanford/groups/menon/projects/mellache/2021_foundation_model/data/imaging/for_dnn/adhd_cmihbn_age_ADHD_wIDS/fold_0.bin'
...
lin_params = np.load('/oak/stanford/groups/menon/projects/mellache/2024_age_prediction/scripts/generalization/cmihbn_updated/lin_params_td_cmihbn.npz')
...
np.savez('actual_cmihbn_adhd_ages_most_updated',actual=actual_ages)
np.savez('predicted_cmihbn_adhd_ages_most_updated',predicted=predicted_ages)
pdb.set_trace()
...
ax.set_title("CMI-HBN ADHD Brain Age Prediction",fontsize=16,pad=10)
plt.tight_layout(pad=1.2)
#plt.savefig('cmihbn_adhd_brain_age_scatter_ensemble_prediction_test_bias_correction_high_quality.png',format='png')
pdf.FigureCanvas(fig).print_pdf('cmihbn_adhd_brain_age_scatter_ensemble_prediction_all_td_bias_correction_high_quality.ai')
